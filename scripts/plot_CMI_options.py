...
CMI_vNotl0_el0 = pred.CMI(l0=True)
...
plt.tight_layout()
plt.savefig('plts/CMI_options.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('plts/CMI_edges_options.png', dpi=300, bbox_inches='tight')
