...
A lot more work is available to be done here in the bandpass interpretation of CMI, but further discussion here is limited by the time constraints of this thesis.
...
\begin{itemize}
    ...
    \item Fitting the correlation vs distance function with a 3D Matern kernel with $\lambda=0.0019km^{-1}$.
...
The NOAA dataset exhibits significant similarity in its correlation vs distance function with that found for the BOM dataset.
\subsection*{L0 Coordinte Descent}
